...
public class Container {
    // Optimized for Skullgirls 2nd Encore on Samsung Galaxy A56 (Exynos 1580 / Xclipse 540 RDNA2)
    // DXVK_ASYNC=1      -> async shader compilation, eliminates first-run stutter
    // DXVK_LOG_LEVEL=none -> no logging overhead
    // MESA_SHADER_CACHE_MAX_SIZE=1024MB -> larger cache for game shaders
    public static final String DEFAULT_ENV_VARS = "ZINK_DESCRIPTORS=lazy ZINK_DEBUG=compact MESA_SHADER_CACHE_DISABLE=false MESA_SHADER_CACHE_MAX_SIZE=1024MB mesa_glthread=true WINEESYNC=1 TU_DEBUG=noconform DXVK_ASYNC=1 DXVK_LOG_LEVEL=none";
